...
# =========================================================
# Image Upscale & Compress
# =========================================================

@app.post("/api/upscale_image")
async def upscale_image(
    ...
    scale_factor = max(1, min(scale, 4))
    ...
    return png_response_with_author(upscaled.convert("RGB"))


@app.post("/api/compress_image")
async def compress_image(
    ...
    if max_width > 0 and image.width > max_width:
        ...
        processed = image.resize((max_width, new_height), Image.Resampling.LANCZOS)
    ...
    return Response(
        ...
        headers={"Content-Disposition": 'attachment; filename="compressed-image.jpg"'}
    )
